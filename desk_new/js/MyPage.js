...
function Page(){
    ...
    this.pageHtml = function(){
        ...
        if(pageIndex <= 0 || pageIndex == 1){
            pageHtml += '<li class="disabled"><a href="javascript:;" data-pageindex="'+ pageIndex +'" class="clickPage">首页</a></li>' +
                '<li class="disabled"><a href="javascript:;" data-pageindex="'+ pageIndex +'" class="clickPage">上一页</a></li>';
        }else{
            pageHtml += '<li><a href="javascript:;" data-pageindex="1" class="clickPage">首页</a></li>' +
                '<li><a href="javascript:;" data-pageindex="'+ (pageIndex - 1) +'" class="clickPage">上一页</a></li>';
        }

        for(var i = k;i < (k + j);i++){
            if(pageTotal == (pageIndex + i - 1))break;
            if(i == 0){
                pageHtml += '<li class="active"><a href="javascript:;" data-pageindex="'+ pageIndex +'" class="clickPage">'+ pageIndex +'</a></li>';
            }else{
                pageHtml += '<li><a href="javascript:;" data-pageindex="'+ (pageIndex + i) +'" class="clickPage">'+ (pageIndex + i) +'</a></li>';
            }
        }

        if(pageTotal == 1 ||  pageTotal <= pageIndex){
            pageHtml += '<li class="disabled"><a href="javascript:;" data-pageindex="'+ pageTotal +'" class="clickPage">下一页</a></li>' +
                '<li class="disabled"><a href="javascript:;" data-pageindex="'+ pageTotal +'" class="clickPage">末页</a></li>';
        }else{
            pageHtml += '<li><a href="javascript:;" data-pageindex="'+ (pageIndex + 1) +'" class="clickPage">下一页</a></li>' +
                '<li><a href="javascript:;" data-pageindex="'+ pageTotal +'" class="clickPage">末页</a></li>';
        }
        pageHtml += '</ul>'
        $(elemId).html('');
